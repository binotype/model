...
describe("binotype.Path", () => {
	...
	it("empty path", () => {
		const empty = binotype.Path.empty
	...
	it.each([
		...
		{ input: "SplendidUITools", casing: "snake", expected: "splendid-ui-tools" },
		{ input: "HowDoIDo", casing: "snake", expected: "how-do-i-do" },
	...
	it("immutability", () => {
		const original = binotype.Path.parse("/home/user")
