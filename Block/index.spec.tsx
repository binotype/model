...
describe("binotype.Block", () => {
	it.each([
		{
			name: "minimal block with string content",
			block: {
				content: <Fragment>Sample content</Fragment>,
			},
		},
		{
			name: "minimal block with empty string content",
			block: {
		...
		},
		{
			...
			block: {
				title: {
					short: "Short",
					long: <Fragment>Long Title</Fragment>,
				},
		...
		},
		{
			...
			block: {
				...
				blocks: {
					subsection1: {
						content: <Fragment>Nested content 1</Fragment>,
					},
					subsection2: {
						title: "Sub Title",
						content: <Fragment>Nested content 2</Fragment>,
					},
				},
			},
		},
			...
			block: {
				blocks: {
					level1: {
						blocks: {
							level2: {
								content: <Fragment>Deep nesting works</Fragment>,
							},
						},
					},
				},
		...
		{
			name: "block with zero weight",
			block: {
				weight: 0,
				content: <Fragment>"Zero weight section"</Fragment>,
			},
		},
		{
		...
		expect(binotype.Block.is(block)).toBe(true)
	)
	...
	it.each([
		...
		},
		{
			...
			block: {
				weight: "10",
				content: <Fragment>Valid content</Fragment>,
			},
		},
		{
